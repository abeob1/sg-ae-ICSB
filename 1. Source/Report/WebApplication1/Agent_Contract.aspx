            ...
            <div class="form-body">
                <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control datepicker" id="Text1" placeholder="Validity To">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="Email6" placeholder="Agent Code">
                        </div>
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="Text2" placeholder="Agent Name">
                        </div>
                    </div>
