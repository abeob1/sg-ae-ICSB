            ...
            <div class="form-body">
                <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control datepicker" id="Email3" placeholder="Validity From">
                        </div>
                        <div class="col-sm-4">
                            <input type="text" class="form-control datepicker" id="Email1" placeholder="Validity From">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputEmail3" class="col-sm-4 control-label">
                        ...
                        <div class="col-sm-8">
                            <input type="email" class="form-control" id="Email6" placeholder="Customer Code">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputEmail3" class="col-sm-4 control-label">
                        ...
                        <div class="col-sm-8">
                            <input type="email" class="form-control" id="Email7" placeholder="Customer Name">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputEmail3" class="col-sm-4 control-label">
                    ...
                    <span>
                        <button class="btn btn-success">
                            Save</button></span>
                             ...
                             <span><button class="btn btn-primary">Mgmt. Approval</button></span>
                             <span><button class="btn btn-primary">Copy to Contract</button></span>
