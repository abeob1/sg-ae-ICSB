...
Public Class CleaningCertificateReport_NewFormat
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        rpt.Load(Server.MapPath("~/Reports/") + "Web_Cleaning_Certificate_NewFormat.rpt")
        rpt.SetDatabaseLogon(strUID, strPassword)
        'rpt.SetDatabaseLogon(strUID, strPassword, strServer, strDBName)
        ...
        Dim sFileName As String = Convert.ToString("CleaningCertificateReport_NewFormat ") & datetimeString
