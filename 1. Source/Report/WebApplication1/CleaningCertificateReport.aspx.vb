...
Public Class CleaningCertificateReport
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        rpt.Load(Server.MapPath("~/Reports/") + "Web_Cleaning_Certificate.rpt")
        ...
        Dim sFileName As String = Convert.ToString("CleaningCertificateReport ") & datetimeString
