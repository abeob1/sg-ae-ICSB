App.controller('ccSurvey1_ctrl', ['$scope', '$rootScope', '$http', '$window', '$cookies','util_SERVICE','css1_SERVICE','hotkeys','$location',
...
$scope.afterSave = function()
{
    ...
    $scope.data.ODLN[0].U_Capacity = "";
		...
		$scope.data.ODLN[0].U_VAL_Val="NO";
		...
		$scope.data.ODLN[0].U_VAL_Avail="NO";
   ...
   .then(
    ...
    $scope.Survey_Result_changed = function()
    {
        ...
        if($scope.data.ODLN[0].U_SResult=="Accepted")
        {
		    ...
		    //$scope.data.ODLN[0].U_INT_Pitt="YES";
		    //$scope.data.ODLN[0].U_INT_Disc="YES";
