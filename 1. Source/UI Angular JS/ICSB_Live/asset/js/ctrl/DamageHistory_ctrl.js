App.controller('DamageHistory_ctrl', ['$scope', '$rootScope', '$http', '$window', '$cookies','util_SERVICE','DH_SERVICE','hotkeys','$location',

function ($scope, $rootScope, $http, $window, $cookies,US,DH,hotkeys,$location) {
   ...
   $rootScope.FindoneRecord = function(code)
    {   
         ...
         DH.FindRecord(code).then(function (response) {console.log(response);$scope.data=response.data;
         $scope.updateclick();
   ...
   // DH.getetype().then(function (response) { $scope.etype = response.data.SURCRTA; });
   // DH.getSurveyCriteria().then(function (response) { $scope.SurveyCriteria = response.data.SURCRTA;  });
   // DH.getSurveyorIDMaster().then(function (response) { $scope.SurveyorIDMaster = response.data.SUID; });//get full surveyer
    ...
    $scope.findDH = function()
    {
   
        DH.getDH($scope.U_SurvyNo).then(function (response) { $scope.DH = response.data.ODLN;  });//get full DH
    ...
    if(type=='code')
    {
        ...
        n=$scope.data.ODLN[0].CardName;
         ...
         DH.getcustomer(c,n).then(function (response) { $rootScope.customer = response.data; $("#myModal").modal(); 
                });
    }
     ...
     $scope.getsurveyorID = function()
    {
         ...
         DH.getsurveyorID($scope.data.ODLN[0].U_UName).then(function (response) { $rootScope.surveyor = response.data; $("#myModal2").modal(); 
                });
    }
    ...
    $scope.getsurveyAgent = function()
    {
         ...
         DH.getsurveyAgent().then(function (response) { $rootScope.surveyorAgent = response.data; $("#Modal3").modal(); 
                });
    }
    ...
    $scope.PreviousRecord = function()
    {
         ...
         DH.PreviousRecord($scope.data.ODLN[0].U_OrderNo,$scope.UserData[0].Code).then(function (response) {console.log(response);$scope.data=response.data; $scope.updateclick();});
    }
    ...
    $scope.NextRecord = function()
    {
         ...
         DH.NextRecord($scope.data.ODLN[0].U_OrderNo,$scope.UserData[0].Code).then(function (response) {console.log(response);$scope.data=response.data;$scope.updateclick();});
    }
    ...
    $scope.LastRecord = function()
    {
         ...
         DH.LastRecord($scope.UserData[0].Code).then(function (response) {console.log(response);$scope.data=response.data;$scope.updateclick();});
    }
    ...
    $scope.FirstRecord = function()
    {
         ...
         DH.FirstRecord($scope.UserData[0].Code).then(function (response) {console.log(response);$scope.data=response.data;$scope.updateclick();});
    }
    ...
    {   
         ...
         DH.FindMultiRecord($scope.data.SQTO[0]).then(function (response) {$rootScope.findresult = response.data; console.log($rootScope.findresult); $("#findmodal").modal();
   ...
   $scope.setaddress = function(name)
   {
    ...
    if($scope.val())
    {
        ...
        $http.post("http://119.73.138.58:82/ICSB.asmx/AnyOther_SurveyTyepAdd", "value=" + parms, config)
   .then(
       function (response) {
           // success callback
    ...
    $scope.SQM_Approval = function()
    {
        ...
        //DH.SQMApproval($scope.data.SQTO.U_Qno).then(function (response) { console.log(response); });
        DH.aproval($scope.data.SQTO[0].U_Qno).then(function (response) {
     ...
     $rootScope.Reject = function()
    {
        ...
        DH.approver($scope.data.SQTO[0].U_Qno,'Rejected',remarks,uname).then(function (response) {
        if (response.data.APPROVAL[0].Status == "True") {             
              // $scope.addclick();
              alert(response.data.APPROVAL[0].Msg);
     ...
     $rootScope.Approved = function()
    {
        ...
        DH.approver($scope.data.SQTO[0].U_Qno,'Approved',remarks,uname).then(function (response) {
        if (response.data.APPROVAL[0].Status == "True") {             
               //$scope.addclick();
              alert(response.data.APPROVAL[0].Msg);
               window.location = "SqApproval.aspx";
    ...
    if($scope.val())
    {
        ...
        var parms = encodeURIComponent(JSON.stringify($scope.data));
        $http.post("http://119.73.138.58:82/ICSB.asmx/AnyOther_SurveyTyepUpdate", "value=" + parms, config)
   .then(
       function (response) {
           // success callback
           console.log(response.data);
    ...
    if(true)
    {
        ...
        $http.post("http://119.73.138.58:82/ICSB.asmx/DamageHistory", "value=" + parms, config)
   .then(
       function (response) {
           // success callback
           console.log(response.data);
