...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <script src="asset/js/services/ONHS_service.js" ></script>
    <script src="asset/js/ctrl/ONHS_ctrl.js"></script>

    <div class="forms" ng-controller="ONHS_ctrl">
      ...
      <span class="input-group-btn">
        ...
        <button class="btn btn-info" type="button" ng-disabled="false" ><i class="fa fa-search" aria-hidden="true" ng-click="getsurveyorID();"></i></button>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" ng-disabled="false" capitalize ng-model="data.ODLN[0].NumAtCard" class="form-control" id="Email5"
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" capitalize ng-model="data.ODLN[0].Project" ng-disabled="true"/>
  ...
  <tr>
    <td>D.O.M</td>
    <td><input type="text" capitalize class="form-control datepicker" id="Number1" ng-model="data.ODLN[0].U_DOM" ></td>
    
  </tr>
  <tr>
    <td>MGW (Kg)</td>
    <td><input type="text" capitalize class="form-control" id="Text7" ng-model="data.ODLN[0].U_MGW" ></td>
    
  </tr>
  <tr>
    <td>Tare (Kg)</td>
    <td><input type="text" capitalize class="form-control" id="Text10" ng-model="data.ODLN[0].U_Tare"  ></td>
    
  </tr>
  <tr>
    <td>ACEP / CSC Number</td>
    <td><input type="text" class="form-control" capitalize id="Text13" ng-model="data.ODLN[0].U_ACEP" ></td>
    
  </tr>
  <tr>
    <td>CSC Due Date</td>
    <td><input type="text" capitalize class="form-control datepicker" id="Text16" ng-model="data.ODLN[0].U_CSC" ></td>
