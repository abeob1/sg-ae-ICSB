...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <script src="asset/js/services/css1_NewFormat_service.js"></script>
    <script src="asset/js/ctrl/ccSurvey1_NewFormat_ctrl.js"></script>
    <div class="forms" ng-controller="ccSurvey1_NewFormat_ctrl">
        <div class="form-grids row widget-shadow" data-example-id="basic-forms">
            <div class="form-title">
                <div class="col-lg-5">
                    <h4>
                        Cleaning survey - Format 2 :</h4>
                </div>
            ...
            <div class="form-body">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select class="form-control" ng-disabled="true" ng-options="item.U_Stype as item.U_StypeName for item in stype"
                                ng-model="data.ODLN[0].U_STypeCode">
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                <input type="text" ng-model="data.ODLN[0].CardCode" ng-disabled="true" class="form-control"
                                    id="Email6" placeholder="Company Code">
                                <span class="input-group-btn">
                                    <button class="btn btn-info" type="button" ng-disabled="true" ng-click="getcustomer();">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                <input type="text" ng-model="data.ODLN[0].CardName" ng-disabled="true" class="form-control"
                                    id="Email7" placeholder="Company Name">
                                <span class="input-group-btn">
                                    <button class="btn btn-info" type="button" ng-disabled="true" ng-click="getcustomer();">
                                        <i class="fa fa-search" aria-hidden="true"></i>
                                    </button>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                <input type="text" ng-disabled="updatebtn" ng-keydown="SIselected=false" ng-model="data.ODLN[0].U_SurveyorID"
                                    class="form-control" id="Text1" placeholder="Surveyor ID">
                                <span class="input-group-btn">
                                    <button class="btn btn-info" type="button" ng-disabled="updatebtn" ng-click="getsurveyorID();">
                                        <i class="fa fa-search" aria-hidden="true"></i>
                                    </button>
                                </span>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" capitalize ng-disabled="false" ng-model="data.ODLN[0].NumAtCard"
                                class="form-control" id="Email5" placeholder="Customer Reference">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select class="form-control" ng-disabled="true" ng-options="item.U_Country as item.U_CountryName for item in CountryMaster"
                                ng-model="data.ODLN[0].U_Country" ng-change="getcity(d.U_Country);">
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select class="form-control" ng-disabled="true" ng-options="item.U_Loc as item.U_LocName for item in location"
                                ng-model="data.ODLN[0].U_Loc">
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" capitalize class="form-control" ng-model="data.ODLN[0].Project"
                                ng-disabled="true" />
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                <input type="text" ng-disabled="false" ng-model="data.ODLN[0].U_SuvExAgent" class="form-control"
                                    id="Text2" placeholder="Agent Company">
                                <span class="input-group-btn">
                                    <button class="btn btn-info" type="button" ng-disabled="false">
                                        <i class="fa fa-search" aria-hidden="true" ng-click="getsurveyAgent();"></i>
                                    </button>
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select class="form-control" ng-disabled="true" ng-options="item.U_EQTYPECODE as item.U_EQTYPENAME for item in etype"
                                ng-model="data.ODLN[0].U_Eqtype">
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select class="form-control" ng-disabled="false" ng-options="item.U_SURCRTACODE as item.U_SURCRTANAME for item in SurveyCriteria"
                                ng-model="data.ODLN[0].U_SCriteria">
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select ng-disabled="updatedisabled" class="form-control" ng-options="item.Name as item.Name for item in IMO"
                                ng-model="data.ODLN[0].U_IMO">
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div style="position: relative">
                                <div class="tooltiptext" id="equtool">
                                    Sample: MSCU 123456 7</div>
                            </div>
                            <input type="text" ng-keypress="checkEQNO($event.charCode);" onfocus="toolshow('equtool');"
                                onblur="toolhide('equtool');" capitalize ng-model="data.ODLN[0].U_EqNo" ng-blur="getDamageHistory(data.ODLN[0].U_EqNo);"
                                class="form-control" id="Text5" placeholder="Equipment No">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputEmail3" class="col-sm-4 control-label">
                    ...
                    <div id="myTabContent" class="tab-content scrollbar1">
                        <div role="tabpanel" class="tab-pane fade active in" id="General" aria-labelledby="General-tab-tab">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" capitalize class="form-control datepicker" id="Text7" ng-model="data.ODLN[0].U_CSC"
                                            onclick="return Text7_onclick()">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-4 control-label">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="Text3" ng-disabled='false' capitalize
                                            ng-model="data.ODLN[0].U_Tare" ng-init="{{data.ODLN[0].U_Tare=data.ODLN[0].U_MGW-data.ODLN[0].U_PayLoad}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-4 control-label">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="checkbox" name="vehicle" value="Bike" style="width: 30px; height: 30px;"
                                            ng-model="data.ODLN[0].U_EX_Fram" ng-true-value="'YES'" ng-false-value="'NO'">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-10 control-label">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="checkbox" name="vehicle" value="Bike" style="width: 30px; height: 30px;"
                                            ng-model="data.ODLN[0].U_EX_Man" ng-true-value="'YES'" ng-false-value="'NO'">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-10 control-label">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="checkbox" name="vehicle" value="Bike" style="width: 30px; height: 30px;"
                                            ng-model="data.ODLN[0].U_EX_Ser" ng-true-value="'YES'" ng-false-value="'NO'">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-10 control-label">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="checkbox" name="vehicle" value="Bike" style="width: 30px; height: 30px;"
                                            ng-model="data.ODLN[0].U_EX_Car" ng-true-value="'YES'" ng-false-value="'NO'">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-4 control-label">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <select class="form-control" ng-disabled="flase" ng-model="data.ODLN[0].U_INT_Cleanliness">
                                            <option value='FITTED'>FIT</option>
                                ...
                                <div class="col-sm-4">
                                    <%--<input type="checkbox" name="vehicle" value="Bike" style="width: 30px; height: 30px;" ng-model="data.ODLN[0].U_INT_Dry" ng-true-value="'YES'" ng-false-value="'NO'">--%>
                                        <select class="form-control" ng-disabled="flase" ng-model="data.ODLN[0].U_INT_Dry">
                                            <option value='FITTED'>FIT</option>
                                            <option value='NOT FITTED'>NOT FITTED</option>
                                        </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <select class="form-control" ng-disabled="flase" ng-model="data.ODLN[0].U_INT_Free">
                                        <option value='FITTED'>FIT</option>
                                        <option value='NOT FITTED'>NOT FITTED</option>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <%--<input type="checkbox" name="vehicle" value="Bike" style="width:30px;height:30px;"  ng-model="data.ODLN[0].U_INT_Free"  ng-true-value="'YES'" ng-false-value="'NO'"> --%>
                                    <select class="form-control" ng-disabled="flase" ng-model="data.ODLN[0].U_INT_Rust">
                                        <option value='FITTED'>FIT</option>
                                        <option value='NOT FITTED'>NOT FITTED</option>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <%--<input type="checkbox" name="vehicle" value="Bike" style="width:30px;height:30px;"  ng-model="data.ODLN[0].U_INT_Free"  ng-true-value="'YES'" ng-false-value="'NO'"> --%>
                                    <select class="form-control" ng-disabled="flase" ng-model="data.ODLN[0].U_INT_Deposits">
                                        <option value='FITTED'>FIT</option>
                                        <option value='NOT FITTED'>NOT FITTED</option>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <%--<input type="checkbox" name="vehicle" value="Bike" style="width: 30px; height: 30px;" ng-model="data.ODLN[0].U_INT_Pitt" ng-true-value="'YES'" ng-false-value="'NO'">--%>
                                        <select class="form-control" ng-disabled="flase" ng-model="data.ODLN[0].U_INT_Pitt">
                                        <option value='FITTED'>FIT</option>
                                        <option value='NOT FITTED'>NOT FITTED</option>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <%--<input type="checkbox" name="vehicle" value="Bike" style="width: 30px; height: 30px;" ng-model="data.ODLN[0].U_INT_Pitt" ng-true-value="'YES'" ng-false-value="'NO'">--%>
                                        <select class="form-control" ng-disabled="flase" ng-model="data.ODLN[0].U_INT_DamagedCoating">
                                        <option value='FITTED'>FIT</option>
                                        <option value='NOT FITTED'>NOT FITTED</option>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <%--<input type"checkbox" name="vehicle" value="Bike" style="width: 30px; height: 30px;" ng-model="data.ODLN[0].U_INT_Pitt" ng-true-value="'YES'" ng-false-value="'NO'">--%>
                                        <select class="form-control" ng-disabled="flase" ng-model="data.ODLN[0].U_INT_GasketMainHole">
                                        <option value='FITTED'>FIT</option>
                                        <option value='NOT FITTED'>NOT FITTED</option>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-8 control-label">
                                    Free from all Cargo and Contamination
                                </label>
                                <div class="col-sm-4">
                                    <select class="form-control" ng-disabled="flase" ng-model="data.ODLN[0].U_INT_Clean">
                                        <option value='FITTED'>FIT</option>
                                        <option value='NOT FITTED'>NOT FITTED</option>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control" ng-disabled="flase" ng-model="data.ODLN[0].U_INT_Disc">
                                        <option value='FITTED'>FIT</option>
                                        <option value='NOT FITTED'>NOT FITTED</option>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-8 control-label">
                                    Drain bottom line discharge must be oil and Dirt Free
                                </label>
                                <div class="col-sm-4">
                                    <select class="form-control" ng-disabled="flase" ng-model="data.ODLN[0].U_INT_OilDirtFree">
                                        <option value='FITTED'>FIT</option>
                                        <option value='NOT FITTED'>NOT FITTED</option>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-8 control-label">
                                    Steam coil must be foreign material free
                                </label>
                                <div class="col-sm-4">
                                    <select class="form-control" ng-disabled="flase" ng-model="data.ODLN[0].U_INT_SteamCoil">
                                        <option value='FITTED'>FIT</option>
                                        <option value='NOT FITTED'>NOT FITTED</option>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-8 control-label">
                                    Tank was steam cleaned
                                </label>
                                <div class="col-sm-4">
                                    <select class="form-control" ng-disabled="flase" ng-model="data.ODLN[0].U_INT_Steam_Cleaned">
                                        <option value='FITTED'>FIT</option>
                                        <option value='NOT FITTED'>NOT FITTED</option>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-8 control-label">
                                    Gasket at bottom discharge value
                                </label>
                                <div class="col-sm-4">
                                    <select class="form-control" ng-disabled="flase" ng-model="data.ODLN[0].U_INT_GasktDschrgval">
                                        <option value='FITTED'>FIT</option>
                                        <option value='NOT FITTED'>NOT FITTED</option>
                                    </select>
                                </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" capitalize ng-model="data.ODLN[0].U_SEAL_NEXT"
                                        maxlength="30" value="unknown" />
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row" align="right">
                <span>
                    ...
                    <button type="button" class="btn btn-success" ng-click="save();" ng-model="savebtn"
                        ng-show="Showsavebtn">
                        {{savelable}}</button>
                    <button type="button" class="btn btn-success" ng-disabled="data.ODLN[0].U_Status=='Closed'"
                        ng-click="update();" ng-model="updatebtn" ng-show="updatebtn">
                ...
                <div class="modal-body" style="overflow: auto; height: 400px;">
                    <table width="100%" border="0" class="table table-bordered table-responsive" cellspacing="5"
                        ...
                        <tr ng-repeat="d in customer.OCRD">
                            ...
                            <td>
                                <button ng-click="findone($index)" class="btn btn-sm btn-primary" data-dismiss="modal">
                                    Select</button>
                            </td>
                        </tr>
                    </table>
                ...
                <div class="modal-body" style="overflow: auto; height: 400px;">
                    <table width="100%" border="0" class="table table-bordered table-responsive" cellspacing="5"
                        ...
                        <tr ng-repeat="d in findresult.ODLN">
                            ...
                            <td>
                                <button ng-click="FindoneRecord(d.U_Qno);" class="btn btn-sm btn-primary" data-dismiss="modal">
                                    Select</button>
                            </td>
                        </tr>
                        <tr class="text-danger" ng-if="findresult.VALIDATE[0].Status =='False'">
                ...
                <div class="modal-body" style="overflow: auto; height: 400px;">
                    <table width="100%" border="0" class="table table-bordered table-responsive" cellspacing="5"
                        ...
                        <tr ng-repeat="d in surveyorAgent.EXAGENT">
                            ...
                            <td>
                                <button ng-click="FillsurveyorAgent(d.U_ANAME)" class="btn btn-sm btn-primary" data-dismiss="modal">
                                    Select</button>
                            </td>
                        </tr>
                    </table>
                ...
                <div class="modal-body" style="overflow: auto; height: 400px;">
                    <table width="100%" border="0" class="table table-bordered table-responsive" cellspacing="5"
                        ...
                        <tr ng-repeat="d in surveyor.SUID">
                            ...
                            <td>
                                <button ng-click="Fillsurveyor(d.U_SCode,d.U_SName)" class="btn btn-sm btn-primary"
                                    data-dismiss="modal">
                                    Select</button>
                            </td>
                        </tr>
