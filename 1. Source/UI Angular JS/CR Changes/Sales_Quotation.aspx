...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <script src="asset/js/services/SQ_service.js" ></script>
    <script src="asset/js/ctrl/salsequote_ctrl.js"></script>

    <div class="forms" ng-controller="salsequote_ctrl">
        <div class="form-grids row widget-shadow" data-example-id="basic-forms">
            <div class="form-title">
                ...
                <div class="btn-group pull-right" role="group" ng-hide="sqapp" aria-label="Basic example">
            ...
            <div class="form-body">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <span ng-hide="findbtn" >{{data.SQTO[0].U_Qno}}</span>
                            <span ng-show="findbtn"><input type="text" ng-model="data.SQTO[0].U_Qno" class="form-control"
                                id="Text22"></span>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                                ...
                                <input type="text" ng-model="data.SQTO[0].U_Uname" ng-disabled="true" class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" ng-model="data.SQTO[0].U_Cdate" class="form-control datepicker"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" ng-change="set_QTO_date()"  ng-model="data.SQTO[0].U_Qdate1"  ng-disabled="whilefind" class="form-control datepicker"
                                id="QFD" placeholder="Validity From">
                        </div>
                        <div class="col-sm-4">
                            <input type="text" ng-model="data.SQTO[0].U_Qdate2" id ng-disabled="whilefind" class="form-control datepicker"
                                id="QTOD" placeholder="Validity To">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputEmail3" class="col-sm-4 control-label">
                        ...
                        <div class="col-sm-8">
                          <div class="input-group">
                            <input type="text" ng-keydown="CCselected=false" ng-model="data.SQTO[0].U_Ccode" class="form-control" id="Email6"
        ...
        <button class="btn btn-info" type="button"  ng-click="getcustomer('code');"><i class="fa fa-search" aria-hidden="true"></i></button>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                        <div class="input-group">
                         <input type="text" ng-keydown="CCselected=false" ng-model="data.SQTO[0].U_Cname"  class="form-control" id="Email7"
      ...
      <span class="input-group-btn">
        <button class="btn btn-info" type="button"  ng-click="getcustomer('name');"><i class="fa fa-search" aria-hidden="true"></i></button>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" ng-model="data.SQTO[0].U_CPeriod1" ng-disabled="ctype" class="form-control datepicker"
                                id="Email8" placeholder="Period From">
                        </div>
                        <div class="col-sm-4">
                            <input type="text" ng-model="data.SQTO[0].U_CPeriod2" ng-disabled="ctype" class="form-control datepicker"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" ng-model="data.SQTO[0].U_Pcode" class="form-control" id="Email5"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                        <textarea class="form-control" ng-model="data.SQTO[0].U_Remarks"></textarea>
                            
                        </div>
                    </div>
                    <div class="form-group" style="margin-top:35px;" ng-show="data.SQTO[0].U_Status=='Rejected'"  >
                        <label for="inputEmailss" class="col-sm-4 control-label">
                            Reject Remarks 
                        </label>
                        <div class="col-sm-8">
                       <input type="text" readonly="readonly" ng-model="data.SQTO[0].U_ARemarks" class="form-control" id="Text2"
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" ng-model="data.SQTO[0].U_Addr1" ng-disabled="whilefind" class="form-control" id="Email19"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" ng-model="data.SQTO[0].U_Addr2" ng-disabled="whilefind" class="form-control" id="Email9"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" ng-model="data.SQTO[0].U_Addr3" ng-disabled="whilefind" class="form-control" id="Email10"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" ng-model="data.SQTO[0].U_Addr4" ng-disabled="whilefind" class="form-control" id="Email11"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" ng-model="data.SQTO[0].U_Addr5" ng-disabled="whilefind" class="form-control" id="Email13"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" ng-model="data.SQTO[0].U_Addr6" ng-disabled="whilefind" class="form-control" id="Email14"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" ng-model="data.SQTO[0].U_TelNo" ng-disabled="whilefind" class="form-control" id="Email15"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" ng-model="data.SQTO[0].U_FaxNo" ng-disabled="whilefind" class="form-control" id="Email17"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" ng-model="data.SQTO[0].U_Mno" ng-disabled="whilefind" class="form-control" id="Email12"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="email" ng-model="data.SQTO[0].U_Email" ng-disabled="whilefind" class="form-control" id="Email16"
                                placeholder="Email">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div id="myTabContent" class="tab-content scrollbar1">
                        <div role="tabpanel" class="tab-pane fade active in" id="General" aria-labelledby="General-tab-tab">
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <tr ng-repeat="d in data.SQTOGEN | filter:searchText">
                                        <th scope="row">
                                            {{$index+1}}
                                        </th>
                                        <td>
                        ...
                        <div role="tabpanel" class="tab-pane fade in" id="Addon" aria-labelledby="Addon-tab">
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <tr ng-repeat="d in data.SQTOADD | filter:EsearchText">
                                        <th scope="row">
                                            {{$index+1}}
                                        </th>
                                        <td>
    ...
    <div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width:100%;font-size:20px;line-height:25px;">
      Loading...
                    ...
                    <div class="row" align="right" ng-hide="sqapp">
                        <span>
                            <button class="btn btn-success" type="button" ng-click="save();"  ng-disabled="loading" ng-show="savebtn">
                                ...
                                <button type="button" class="btn btn-success" ng-click="UpdateRecord();" ng-disabled="data.SQTO[0].U_Status=='Closed' || data.SQTO[0].U_Status=='Approved'"  ng-show="updatebtn">
                                Update</button>
                                
                                </span> <span>
                                    <a href="SalesOrderReport.aspx?key={{data.SQTO[0].U_Qno}}" target="_blank"><button class="btn btn-primary" type="button" ng-disabled="btndisable">
                                        Print</button></span></a> <span ng-show="data.SQTO[0].U_Status=='Open' || data.SQTO[0].U_Status=='Rejected'">
                                            <button type="button" class="btn btn-primary" ng-click="SQM_Approval();"  ng-disabled="btndisable">
                                                Mgmt. Approval</button></span> <span ng-show="data.SQTO[0].U_Status=='Approved'">
                                                    <button class="btn btn-primary" type="button"  ng-disabled="btndisable" ng-click="CopyToContract();">
                                                        Copy to Contract</button></span> <span>
                                                            <button type="button" class="btn btn-danger" ng-click="resetall();">
                                                                Cancel</button></span></div>

                    <!-- btn for approval service --->
                    <div class="row" align="right" ng-show="sqapp">
                        <span>
                            <button class="btn btn-success" type="button" ng-disabled="checkSQAstatus(data.SQTO[0].U_Status);" ng-click="Approved();" >
                                Approve</button>
                                 </span>
                              <span>
                                    <button class="btn btn-primary" type="button"  ng-disabled="checkSQAstatus(data.SQTO[0].U_Status);"  data-toggle="modal" data-target="#RRemark" >
    ...
    <script>
        ...
        function changeDate() {
            ...
            var CurrentDate = new Date($('#QFD').val());
...
<div id="findmodal" class="modal fade" role="dialog">
 ...
 <!-- Reject Remark Modal -->
<div id="RRemark" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content" >
      ...
      <div class="modal-body" style="overflow:auto;height:250px;">
       <textarea class="form-control" style="height:200px" ng-model='$parent.Rremark' ></textarea>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-info" data-dismiss="modal" ng-click="Reject()">Submit</button>
      </div>
    </div>
