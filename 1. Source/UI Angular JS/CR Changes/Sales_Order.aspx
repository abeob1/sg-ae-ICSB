            ...
            <div class="form-body">
                <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <span ng-hide="findbtn" >{{data.ORDR[0].SODocNum}}</span>
                            <span ng-show="findbtn"><input type="text" ng-model="data.ORDR[0].DocNum" class="form-control"
                                id="Text2"></span>
                        </div>
                    </div>
                    <div class="form-group">
...
<div id="checkSModal" class="modal fade" role="dialog">
  <div class="modal-dialog" style="width:90%">
    ...
    <div class="modal-content" >
      ...
      <button type="button" class="btn-info btn" ng-show="mySdata.OCRD[0].FormatNo >= 2" ng-disabled="mySdata.OCRD[0].OpenQty==0" ng-click="OpenNewFormat()">New Survey Format2 </button>
      </div><br />
        <table width="100%" border="0" class="table table-bordered table-responsive" cellspacing="5" cellpadding="5">
  <tr>
    <td>Link</td>
    <td>Survey No</td>
    <td>Survey SAP Doc.No</td>
