...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <script src="asset/js/services/AS_service.js" ></script>
    <script src="asset/js/ctrl/AgentContract_ctrl.js"></script>

    <div class="forms" ng-controller="AgentContract_ctrl">
            ...
            <div class="form-body">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <span ng-hide="findbtn" >{{data.ACON[0].U_Qno}}</span>
                            <span ng-show="findbtn"><input type="text" ng-model="data.ACON[0].U_Qno" class="form-control"
                                id="Text22"></span>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                                ...
                                <input type="text" ng-model="data.ACON[0].U_Uname" ng-disabled="true" class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" ng-model="data.ACON[0].U_Cdate" class="form-control datepicker"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                          <div class="input-group">
                            <input type="text" ng-keydown="ACselected=false" ng-model="data.ACON[0].U_Agentcode" class="form-control" id="Email6"
                                placeholder="Agent Code">
                                <span class="input-group-btn">
        <button class="btn btn-info" type="button" ng-click="getAgent('code');"><i class="fa fa-search" aria-hidden="true"></i></button>
      </span>
      </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                        <div class="input-group">
                         <input type="text" ng-keydown="ACselected=false" ng-model="data.ACON[0].U_Agentname"  class="form-control" id="Email7"
                                placeholder="Agent Name">
      <span class="input-group-btn">
        <button class="btn btn-info" type="button" ng-click="getAgent('name');"><i class="fa fa-search" aria-hidden="true"></i></button>
      </span>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" ng-model="data.ACON[0].U_CPeriod1" ng-disabled="whilefind" class="form-control datepicker"
                                id="Email8" placeholder="Period From">
                        </div>
                        <div class="col-sm-4">
                            <input type="text" ng-model="data.ACON[0].U_CPeriod2" ng-disabled="whilefind" class="form-control datepicker"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" ng-model="data.ACON[0].U_Pcode" class="form-control" id="Email5"
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" ng-model="data.ACON[0].U_Addr1" ng-disabled="whilefind" class="form-control" id="Email19"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" ng-model="data.ACON[0].U_Addr2" ng-disabled="whilefind" class="form-control" id="Email9"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" ng-model="data.ACON[0].U_Addr3" ng-disabled="whilefind" class="form-control" id="Email10"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" ng-model="data.ACON[0].U_Addr4" ng-disabled="whilefind" class="form-control" id="Email11"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" ng-model="data.ACON[0].U_Addr5" ng-disabled="whilefind" class="form-control" id="Email13"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" ng-model="data.ACON[0].U_Addr6" ng-disabled="whilefind" class="form-control" id="Email14"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" ng-model="data.ACON[0].U_TelNo" ng-disabled="whilefind" class="form-control" id="Email15"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" ng-model="data.ACON[0].U_FaxNo" ng-disabled="whilefind" class="form-control" id="Email17"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" ng-model="data.ACON[0].U_Mno" ng-disabled="whilefind" class="form-control" id="Email12"
                    ...
                    <div id="myTabContent" class="tab-content scrollbar1">
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <thead>
                                    <tr ng-show="filter">
                                        ...
                                        <th>
                                            <select class="form-control" ng-options="item.U_EQTYPECODE as item.U_EQTYPENAME for item in etype" ng-model="searchText.U_EQGroup"></select>
                                        ...
                                        <th>
                                            <input ng-model="searchText.U_Remarks" type="text" class="form-control" />
                                        </th>
                                        <th colspan="3">
                                ...
                                <tbody>
                                    <tr ng-repeat="d in data.ACONGEN | filter:searchText">
                                        <td scope="row">
                                            {{$index+1}}
                                        </td>
                                        <td style="width: 25px">
                                            <span ng-hide="d.edit">{{d.U_Ccode}}</span>
                                           <span ng-show="d.edit"> <input ng-model="d.U_Ccode"  ng-disabled="CCNDE" ng-enter="getEcustomer(d.U_Ccode,d.U_Cname,$index)" class="form-control"> </span>
                                        </td>
                                        <td style="width: 25px">
                                           <span ng-hide="d.edit">{{d.U_Cname}}</span>
                                           <span ng-show="d.edit"> <input ng-model="d.U_Cname"  ng-disabled="CCNDE" ng-enter="getEcustomer(d.U_Ccode,d.U_Cname,$index)" class="form-control"> </span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <span ng-hide="d.edit">{{getegroupName(d.U_EQGroup)}}</span> <span ng-show="d.edit">
                                             ...
                                             <select class="form-control" ng-options="item.U_EQTYPECODE as item.U_EQTYPENAME for item in etype" ng-model="d.U_EQGroup"></select>
                                    ...
                                    <tr style="background-color:White;">
                                        ...
                                        <td style="width: 25px">
                                            <input ng-model="Ccode" ng-disabled="CCND" ng-enter="getcustomer()" ng-keydown="ACGselected=false"  onfocus="toolshow('cus');" onblur="toolhide('cus');" class="form-control"><div style="position:relative"><div class="tooltiptext" id="cus">Press Enter Key To search</div></div>
                                        </td>
                                        <td style="width: 25px">
                                            <input ng-model="Cname" ng-disabled="CCND" ng-enter="getcustomer()" ng-keydown="ACGselected=false" onfocus="toolshow('cus');" onblur="toolhide('cus');" class="form-control">
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                        <select class="form-control" ng-options="item.U_EQTYPECODE as item.U_EQTYPENAME for item in etype" ng-model="g_egroup"></select>
                                        ...
                                        <td>
                                            <input ng-model="g_remark" type="text" class="form-control" />
                                        </td>
                                        <td>
                        ...
                        <div role="tabpanel" class="tab-pane fade in" id="Addon" aria-labelledby="Addon-tab">
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <tr ng-repeat="d in data.ACONADD | filter:EsearchText">
                                        <th scope="row">
                                            {{$index+1}}
                                        </th>
                                         <td style="width: 25px">
                                            <span ng-hide="d.edit">{{d.U_Ccode}}</span>
                                           <span ng-show="d.edit"> <input ng-model="d.U_Ccode"  ng-disabled="CCNDE" ng-enter="A_getEcustomer(d.U_Ccode,d.U_Cname,$index)" class="form-control"> </span>
                                        </td>
                                        <td style="width: 25px">
                                           <span ng-hide="d.edit">{{d.U_Cname}}</span>
                                           <span ng-show="d.edit"> <input ng-model="d.U_Cname"  ng-disabled="CCNDE" ng-enter="A_getEcustomer(d.U_Ccode,d.U_Cname,$index)" class="form-control"> </span>
                                        </td>
                                    ...
                                    <tr style="background-color:White;">
                                        ...
                                        <td style="width: 25px">
                                            <input ng-model="ECcode" ng-disabled="ACCND" ng-keydown="ACAselected=false" ng-enter="A_getcustomer()"  onfocus="toolshow('Acus');" onblur="toolhide('Acus');" class="form-control"><div style="position:relative"><div class="tooltiptext" id="Acus">Press Enter Key To search</div></div>
                                        </td>
                                        <td style="width: 25px">
                                            <input ng-model="ECname" ng-disabled="ACCND"  ng-keydown="ACAselected=false" ng-enter="A_getcustomer()" onfocus="toolshow('Acus');" onblur="toolhide('Acus');" class="form-control">
                                        </td>
                                        <td>                                        
...
<div id="myModal" class="modal fade" role="dialog">
  ...
  <tr ng-repeat="d in customer.OCRD">
    <td>{{d.U_Ccode}}</td>
    <td>{{d.U_Cname}}</td>
    <td><button ng-click="setcustomer(d.U_Ccode,d.U_Cname);" class="btn btn-sm btn-primary" data-dismiss="modal">Select</button></td>
  </tr>
</table>
      </div>
      <div class="modal-footer">
...
<div id="myModalEdit" class="modal fade" role="dialog">
  ...
  <tr ng-repeat="d in customer.OCRD">
    <td>{{d.U_Ccode}}</td>
    <td>{{d.U_Cname}}</td>
    <td><button ng-click="setEcustomer(d.U_Ccode,d.U_Cname,Cindex);" class="btn btn-sm btn-primary" data-dismiss="modal">Select</button></td>
  </tr>
</table>
      </div>
      <div class="modal-footer">
  ...
  <!-- Counstomber Addon modle -->
<div id="A_myModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
  ...
  <tr ng-repeat="d in customer.OCRD">
    <td>{{d.U_Ccode}}</td>
    <td>{{d.U_Cname}}</td>
    <td><button ng-click="A_setcustomer(d.U_Ccode,d.U_Cname);" class="btn btn-sm btn-primary" data-dismiss="modal">Select</button></td>
  </tr>
</table>
      </div>
      <div class="modal-footer">
...
<!-- Counstomber modle for Addon edit -->
<div id="A_myModalEdit" class="modal fade" role="dialog">
  <div class="modal-dialog">
  ...
  <tr ng-repeat="d in customer.OCRD">
    <td>{{d.U_Ccode}}</td>
    <td>{{d.U_Cname}}</td>
    <td><button ng-click="A_setEcustomer(d.U_Ccode,d.U_Cname,Cindex);" class="btn btn-sm btn-primary" data-dismiss="modal">Select</button></td>
  </tr>
</table>
      </div>
      <div class="modal-footer">
...
<div id="findmodal" class="modal fade" role="dialog">
  ...
  <tr ng-repeat="d in findresult.ACON">
   <td>{{d.U_Qno}}</td>
    <td>{{d.U_Status}}</td>
    <td>{{d.U_Uname}}</td>
    <td>{{d.U_Cdate}}</td>
