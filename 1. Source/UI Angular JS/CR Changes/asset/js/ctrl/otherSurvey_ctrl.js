App.controller('otherSurvey_ctrl', ['$scope', '$rootScope', '$http', '$window', '$cookies','util_SERVICE','OSS_SERVICE','hotkeys','$location',

function ($scope, $rootScope, $http, $window, $cookies,US,OSS,hotkeys,$location) {
   ...
   $rootScope.FindoneRecord = function(code)
    {   
         ...
         OSS.FindRecord(code).then(function (response) {console.log(response);$scope.data=response.data;
         $scope.updateclick();
   ...
   //adding shortcuts
    ...
    OSS.getetype().then(function (response) { $scope.etype = response.data.SURCRTA; });
    OSS.getSurveyCriteria().then(function (response) { $scope.SurveyCriteria = response.data.SURCRTA;  });
    OSS.getSurveyorIDMaster().then(function (response) { $scope.SurveyorIDMaster = response.data.SUID; });//get full surveyer

    $scope.ToggleLink = function(surveyname)
    {
        OSS.ToggleLink($scope.U_STypeCode).then(function(response){$scope.HlinkBef = response.data.U_HYPERLINK_BEFORE; console.log($scope.HlinkBef); })
    }
    ...
    if(type=='code')
    {
        ...
        n=$scope.data.ODLN[0].CardName;
         ...
         OSS.getcustomer(c,n).then(function (response) { $rootScope.customer = response.data; $("#myModal").modal(); 
                });
    }
     ...
     $scope.getsurveyorID = function()
    {
         ...
         OSS.getsurveyorID($scope.data.ODLN[0].U_UName).then(function (response) { $rootScope.surveyor = response.data; $("#myModal2").modal(); 
                });
    }
    ...
    $scope.getsurveyAgent = function()
    {
         ...
         OSS.getsurveyAgent($scope.UserData[0].Code).then(function (response) { $rootScope.surveyorAgent = response.data; $("#Modal3").modal(); 
                });
    }
    ...
    $scope.PreviousRecord = function()
    {
         ...
         OSS.PreviousRecord($scope.data.ODLN[0].U_OrderNo,$scope.UserData[0].Code).then(function (response) {console.log(response);$scope.data=response.data; $scope.updateclick();});
    }
    ...
    $scope.NextRecord = function()
    {
         ...
         OSS.NextRecord($scope.data.ODLN[0].U_OrderNo,$scope.UserData[0].Code).then(function (response) {console.log(response);$scope.data=response.data;$scope.updateclick();});
    }
    ...
    $scope.LastRecord = function()
    {
         ...
         OSS.LastRecord($scope.UserData[0].Code).then(function (response) {console.log(response);$scope.data=response.data;$scope.updateclick();});
    }
    ...
    $scope.FirstRecord = function()
    {
         ...
         OSS.FirstRecord($scope.UserData[0].Code).then(function (response) {console.log(response);$scope.data=response.data;$scope.updateclick();});
    }
    ...
    {   
         ...
         OSS.FindMultiRecord($scope.data.SQTO[0]).then(function (response) {$rootScope.findresult = response.data; console.log($rootScope.findresult); $("#findmodal").modal();
   ...
   .then(
    ...
    $scope.SQM_Approval = function()
    {
        ...
        //OSS.SQMApproval($scope.data.SQTO.U_Qno).then(function (response) { console.log(response); });
        OSS.aproval($scope.data.SQTO[0].U_Qno).then(function (response) {
     ...
     $rootScope.Reject = function()
    {
        ...
        OSS.approver($scope.data.SQTO[0].U_Qno,'Rejected',remarks,uname).then(function (response) {
        if (response.data.APPROVAL[0].Status == "True") {             
              // $scope.addclick();
              alert(response.data.APPROVAL[0].Msg);
     ...
     $rootScope.Approved = function()
    {
        ...
        OSS.approver($scope.data.SQTO[0].U_Qno,'Approved',remarks,uname).then(function (response) {
        if (response.data.APPROVAL[0].Status == "True") {             
               //$scope.addclick();
              alert(response.data.APPROVAL[0].Msg);
               window.location = "SqApproval.aspx";
