...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <script src="asset/js/services/OFHS_service.js" ></script>
    <script src="asset/js/ctrl/OFHS_ctrl.js"></script>

    <div class="forms" ng-controller="OFHS_ctrl">
        <div class="form-grids row widget-shadow" data-example-id="basic-forms">
            <div class="form-title">
                <div class="col-lg-5">
                    <h4>
                        Off hire and In-Service survey :</h4>
                </div>
      ...
      <span class="input-group-btn">
        ...
        <button class="btn btn-info" type="button" ng-disabled="false" ><i class="fa fa-search" aria-hidden="true" ng-click="getsurveyorID();"></i></button>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <input capitalize type="text" class="form-control" ng-model="data.ODLN[0].Project" ng-disabled="true"/>
        ...
        <button class="btn btn-info" type="button" ng-disabled="false" ><i class="fa fa-search" aria-hidden="true" ng-click="getsurveyAgent();"></i></button>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" capitalize ng-model="data.ODLN[0].U_EqNo" ng-blur="getDamageHistory(data.ODLN[0].U_EqNo);" class="form-control" id="Text5"
  ...
  <tr>
    ...
    <td><input type="text" class="form-control" id="Number1" ng-model="data.ODLN[0].U_Esti_Org" ng-keyup="sum()"></td>
    <td><input type="text" class="form-control" id="Text3" ng-model="data.ODLN[0].U_Esti_Rev" ng-keyup="sum()"></td>
    <td><input type="text" class="form-control" id="Text4" ng-model="data.ODLN[0].U_Esti_Diff"  ng-disabled="true"></td>
  </tr>
  <tr>
    <td>Currency</td>
    <td><input type="text" class="form-control" ng-model="data.ODLN[0].U_Curr_Org" id="Text7" ng-keyup="sum()"></td>
    <td><input type="text" class="form-control" ng-model="data.ODLN[0].U_Curr_Rev" id="Text8" ng-keyup="sum()"></td>
    <td><input type="text" class="form-control" ng-model="data.ODLN[0].U_Curr_diff" id="Text9"  ng-disabled="true"></td>
  </tr>
  <tr>
    <td>Impact Damage</td>
    <td><input type="text" class="form-control" ng-model="data.ODLN[0].U_Impac_Org" id="Text10" ng-keyup="sum()"></td>
    <td><input type="text" class="form-control" ng-model="data.ODLN[0].U_Impac_Rev" id="Text11" ng-keyup="sum()"></td>
    <td><input type="text" class="form-control" ng-model="data.ODLN[0].U_Impac_diff" id="Text12"  ng-disabled="true"></td>
  </tr>
  <tr>
    <td>Wear &amp; Tear</td>
    <td><input type="text" class="form-control" ng-model="data.ODLN[0].U_Wear_org" id="Text13" ng-keyup="sum()"></td>
    <td><input type="text" class="form-control" ng-model="data.ODLN[0].U_Wear_Rev" id="Text14" ng-keyup="sum()"></td>
    <td><input type="text" class="form-control" ng-model="data.ODLN[0].U_Wear_Diff" id="Text15"  ng-disabled="true"></td>
  </tr>
  <tr>
    <td>Customer Account</td>
    <td><input type="text" class="form-control" ng-model="data.ODLN[0].U_Cust_Org" id="Text16" ng-keyup="sum()"></td>
    <td><input type="text" class="form-control" ng-model="data.ODLN[0].U_Cust_Rev" id="Text17" ng-keyup="sum()"></td>
    <td><input type="text" class="form-control" ng-model="data.ODLN[0].U_Cust_Diff" id="Text18"  ng-disabled="true"></td>
  </tr>
  <tr>
    <td>Improper Repair</td>
    <td><input type="text" class="form-control" ng-model="data.ODLN[0].U_Impor_Org" id="Text19" ng-keyup="sum()"></td>
    <td><input type="text" class="form-control" ng-model="data.ODLN[0].U_Impor_Rev" id="Text20" ng-keyup="sum()"></td>
    <td><input type="text" class="form-control" ng-model="data.ODLN[0].U_Import_Diff" id="Text21"  ng-disabled="true"></td>
  </tr>
  <tr>
    <td>Sum</td>
    <td><input type="text" class="form-control" ng-model="data.ODLN[0].U_Sum_Org" id="Text23" ng-disabled="true"></td>
    <td><input type="text" class="form-control" ng-model="data.ODLN[0].U_Sum_Rev" id="Text24" ng-disabled="true"></td>
    <td><input type="text" class="form-control" ng-model="data.ODLN[0].U_Sum_Diff" id="Text25"  ng-disabled="true"></td>
  </tr>
</table>
                        </div>
